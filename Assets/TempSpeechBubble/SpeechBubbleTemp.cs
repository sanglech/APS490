...
[ExecuteInEditMode]
public class SpeechBubbleTemp : MonoBehaviour 
{
	...
	void Awake() 
	{
		...
		check = GameMaster.control.selfTalk;
	...
	void OnGUI()
	{
		...
		//Render the text
			GUI.Label(new Rect(10,25,190,50),GameMaster.control._postiveStatement,guiSkin.label);
